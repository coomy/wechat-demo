!function (e) {
    if (!e.WeixinJSBridge) {
        ...
        var n = e.hasOwnProperty("document"), useJsCore = !1, callbacks = {}, i = 0, onList = {}, u = "custom_event_", subscribeList = {};
        if (n) {
            var t = e.navigator.userAgent, onAndroid = t.indexOf("Android") != -1;
            useJsCore = !onAndroid;
        }
        var invokeMethod = function (t, n, i) {
            if (useJsCore)e.webkit.messageHandlers.invokeHandler.postMessage({event: t, paramsString: n, callbackId: i}); else {
            ...
            var paramStr = JSON.stringify(params || {}), callbackId = ++i;
...
var Reporter = function (e) {
    ...
    function i() {
        !h || h.length <= 0 || (r("reportKeyValue", {dataArray: h}), h = [])
    }
    ...
    function u() {
        !v || v.length <= 0 || (r("systemLog", {dataArray: v}), v = [])
    }
    ...
    var O = {
        reportKeyValue: function (e) {
            ...
            p.ErrorType[t] && (O.reportIDKey({key: t}), O.reportKeyValue({
                key: "Error",
    ...
    function loadModule(idx) {
        ...
        var r = modules[idx] = {exports: {}, id: idx, loaded: !1};
    ...
    var r = n(1), i = n(6), a = o(i), u = n(1), c = n(4), s = void 0, wvIdToPages = {}, pathToPages = {}, l = 0, d = {
        appRouteTime: 0,
        newPageTime: 0,
        pageReadyTime: 0
    }, h = function (e, t, n) {
        ...
        (0, u.isDevTools)() && (__wxAppData[e] = r.data, __wxAppData[e].__webviewId__ = t, (0, u.publish)(c.UPDATE_APP_DATA)), s = {
            ...
            webviewId: t,
            route: e
        }, r.onLoad(n), r.onShow(), wvIdToPages[t] = {page: r, route: e}, h("appRoute2newPage", d.appRouteTime, d.newPageTime)
    }), v = function (e) {
        e.page.onHide()
    }, y = function (e) {
        e.page.onUnload(), (0, u.isDevTools)() && (delete __wxAppData[e.route], (0, u.publish)(c.UPDATE_APP_DATA)), delete wvIdToPages[e.webviewId]
    }, w = function (e, t, n, o) {
        if ((0, u.info)("On app route: " + e), d.appRouteTime = Date.now(), "navigateTo" === o)s && v(s), wvIdToPages.hasOwnProperty(t) ? (0, u.error)("Page route错误", "navigateTo 一个已经存在的webviewId" + t) : g(e, t, n); else if ("redirectTo" === o)s && y(s), wvIdToPages.hasOwnProperty(t) ? (0, u.error)("Page route错误", "redirectTo 一个已经存在的webviewId" + t) : g(e, t, n); else if ("navigateBack" === o)if (s && y(s), wvIdToPages.hasOwnProperty(t)) {
            var r = wvIdToPages[t].page;
            s = {webviewId: t, route: e, page: r}, r.onShow()
        } else(0, u.error)("Page route错误", "navigateBack 一个不存在的webviewId" + t); else if ("switchTab" === o)if (s && v(s), wvIdToPages.hasOwnProperty(t)) {
            var i = wvIdToPages[t].page;
            s = {webviewId: t, route: e, page: i}, i.onShow()
        } else g(e, t, n); else"appLaunch" === o ? wvIdToPages.hasOwnProperty(t) ? (0, u.error)("Page route错误", "apppLaunch 一个已经存在的webviewId" + t) : g(e, t, n) : (0, u.error)("Page route错误", "非法Open type: " + o)
    }, b = function (e, t, n, o) {
        if (s)s.page.onRouteEnd(); else if ((0, u.warn)("page isn't ready yet"), wvIdToPages.hasOwnProperty(t)) {
            var r = wvIdToPages[t].page;
            s = {webviewId: t, route: e, page: r}, r.onRouteEnd()
        } else g(e, t, n)
    }, m = function (e, t, n) {
        if (!wvIdToPages.hasOwnProperty(e))throw new r.AppServiceEngineKnownError("OnWebviewEvent: " + t + ", WebviewId: " + e + " not found");
        var o = wvIdToPages[e], i = o.page;
    ...
    }(), i = n(1), a = n(2), u = ["onLaunch", "onShow", "onHide", "onUnlaunch"], c = function (e) {
    ...
    var r = function () {
        ...
        return r(e, null, [{
            key: "emit", value: function (e, t) {
                (0, i.info)("Update view with"), (0, i.info)(e), (0, i.publish)("appDataChange", {data: {data: e}}, [t])
            }
        }]), e
    }();
    t.default = a
