!function (e) {
    if (!e.WeixinJSBridge) {
        ...
        var n = e.hasOwnProperty("document"), i = !1, r = {}, o = 0, a = {}, s = "custom_event_", c = {};
        if (n) {
            var t = e.navigator.userAgent, l = t.indexOf("Android") != -1;
            i = !l
        }
        var d = function (t, n, o) {
            if (i)e.webkit.messageHandlers.invokeHandler.postMessage({event: t, paramsString: n, callbackId: o}); else {
        ...
        e.WeixinJSBridge = {invoke: h, invokeCallbackHandler: p, on: A, publish: g, subscribe: f, subscribeHandler: v}
    }
}(this);
